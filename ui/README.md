...
Sapper uses webpack to provide code-splitting and dynamic imports, as well as compiling your Svelte components. It also provides hot module reloading. As long as you don't do anything daft, you can edit the configuration files to add whatever plugins you'd like.
